		...
		<? $course_d = fun::course($lesson_d['cours_id']); ?>
         ...
         <div class="form_c">
            ...
            <? while ($li_d = mysqli_fetch_assoc($li)): ?>
               ...
               <? if ($li_d['type'] == 'video'): ?>
                  <div class="form_im">
                     ...
                     <input type="url" class="form_txt fr_youtube lesson_edt_youtube" data-id="<?=$li_d['id']?>" placeholder="Сілтемесін салыңыз" data-lenght="1" value="<?=$li_d['txt']?>" />
            ...
            <div class="form_im">
               ...
               <input type="url" class="form_txt fr_youtube lesson_ss_youtube" placeholder="Сілтемесін салыңыз" data-lenght="1" />
               <i class="fal fa-play form_icon"></i>
            </div>
            <div class="form_im">
